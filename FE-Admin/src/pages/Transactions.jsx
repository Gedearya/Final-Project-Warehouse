...
function Dashboard() {
  ...
  const handleAscInvoice = () => {
    settransactionData(arraySort(transactionData, "invoice_code"));
    setrefresh(!refresh);
  };

  const handleDescInvoice = () => {
    settransactionData(
      arraySort(transactionData, "invoice_code", {
        reverse: true,
      })
    );
    setrefresh(!refresh);
                  ...
                  <th className='p-2 whitespace-nowrap'>
                    <div className='font-semibold text-center'>
                      ...
                      <button
                        ...
                        onClick={() => handleAscInvoice()}
                      >
                        ↑
                      </button>
                      <button onClick={() => handleDescInvoice()}>↓</button>
                    </div>
                  </th>
                  <th className='p-2 whitespace-nowrap'>
                    <div className='font-semibold text-center'>
